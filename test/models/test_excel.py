...
def test_valid_excel():
    ...
    excel_data = read_json_data('usecases/excel/valid_report.json', True)
...
def test_invalid_filename():
    # Lee los datos del archivo JSON
    excel_data = read_json_data('usecases/excel/invalid_report_name.json', True)
...
def test_invalid_webhook():
    # Lee los datos del archivo JSON
    excel_data = read_json_data('usecases/excel/invalid_report_webhook.json', True)
...
def test_invalid_sheets_length():
    # Lee los datos del archivo JSON
    excel_data = read_json_data('usecases/excel/sheets_empty.json', True)
...
def test_custom_1():
    # Lee los datos del archivo JSON
    excel_data = read_json_data('usecases/excel/custom_1.json', True)
